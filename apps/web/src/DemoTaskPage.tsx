const plans = [
  {
    ...
    features: ["1 active study", "50 sessions"],
  },
  {
    name: "Team",
    price: "$59",
    description: "For a small research team",
    features: ["5 active studies", "500 sessions", "Shared projects"],
    featured: true,
  },
  {
    name: "Studio",
    ...
    features: ["Unlimited studies", "2,000 sessions", "Priority support"],
  },
];
  ...
  return (
    <main className="demo-target-page">
      <nav className="demo-target-nav" aria-label="Demo product navigation">
        <a href="/demo/pricing" className="demo-target-brand">
          Northstar Research
        </a>
        <div>
      ...
      {checkout ? (
        <section className="demo-checkout-card">
          ...
          <a className="primary-button" href="/demo/pricing">
            Back to pricing
          </a>
        </section>
      ) : (
        <>
          ...
          <section className="demo-pricing-grid" aria-label="Pricing plans">
            {plans.map((plan) => (
              <article
                key={plan.name}
                className={plan.featured ? "demo-plan featured" : "demo-plan"}
              >
